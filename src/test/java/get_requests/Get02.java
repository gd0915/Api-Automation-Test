...
*/
    ...
    public void get02(){
        ...
        // Response body contains "Not Found"
        // assertTrue(x) ==> This method passes if the x is true
        assertTrue(response.asString().contains("Not Found")); //true==> response body contains "Not Found"
                                                               //assertTrue() is coming from "junit library"
        System.out.println(response.asString().contains("Not Found")); //true ==>passed

        //Response body does not contain "TechProEd"
        //assertFalse(x) method passes if x is false
        assertFalse(response.asString().contains("TechProEd"));
        System.out.println(response.asString().contains("TechProEd")); //false ==>passed
