...
public class Get09Review extends HerOkuAppBaseUrl {
    /*
        Given
     ...
     */
    @Test
    public void get09ReviewA() {
        //Set the url
        spec.pathParams("first", "booking", "second", 246);

        //Set the expected data
        //First we are looking for the inner part(inner map)
        Map<String, String> bookingdatesMap = new HashMap<>();
        bookingdatesMap.put("checkin", "2018-01-01");
        bookingdatesMap.put("checkout", "2019-01-01");

        //Second we are looking for the outer part(outer map)
